...
async function scrapeWeightliftingData() {
    ...
    try {
        ...
        await page.goto('https://usaweightlifting.sport80.com/public/events/13431/entries/20063?bl=wizard', {
...
${sortedEntries.join(',\n')}
        ...
        fs.writeFileSync('arnold_25/entry/ao125_entries.ts', tsContent);
